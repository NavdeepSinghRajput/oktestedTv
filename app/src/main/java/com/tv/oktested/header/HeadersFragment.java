...
import static androidx.leanback.R.layout.lb_headers_fragment;
...
public class HeadersFragment extends BaseRowFragment {
    ...
    private static final PresenterSelector sHeaderPresenter = new SinglePresenterSelector(
            new RowHeaderPresenter(R.layout.headerdesign));
    ...
    int getBackgroundColor() {
        ...
        if (getActivity().getTheme().resolveAttribute(R.color.white, outValue, true)) {
