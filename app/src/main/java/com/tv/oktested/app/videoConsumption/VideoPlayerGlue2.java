 ...
 * row.
 */
public class VideoPlayerGlue2<T extends PlayerAdapter> extends PlaybackTransportControlGlue<T>  {
...
//    private final OnActionClickedListener mActionListener;
    ...
    public VideoPlayerGlue2(
            Context context, T impl, ArrayList<DataItem> dataItemList, int currentItem) {
        super(context, impl);
