...
public class NoDataRowPresenter extends RowPresenter {

    Presenter mDetailsPresenter;
    Context context;

    public NoDataRowPresenter(Presenter presenter) {
...
//        lp.height = getCardHeight(overview.getContext());
    ...
    protected void onBindRowViewHolder(RowPresenter.ViewHolder holder, Object item) {
        ...
        LinearLayout.LayoutParams params = (LinearLayout.LayoutParams)vh.mDetailsDescriptionFrame.getLayoutParams();
        params.setMargins(50, 0, 50, 0);
        vh.mDetailsDescriptionFrame.setLayoutParams(params);
