...
public class TransitionHelperCustomized {
...
//            return new Scale();
    ...
    public static void addTransitionListener(Object transition, final TransitionHelperCustomized listener) {
        if (listener == null) {
            return;
        }
      /*  if (Build.VERSION.SDK_INT >= 19) {
    ...
    public static void removeTransitionListener(Object transition, TransitionHelperCustomized listener) {
       /* if (Build.VERSION.SDK_INT >= 19) {
