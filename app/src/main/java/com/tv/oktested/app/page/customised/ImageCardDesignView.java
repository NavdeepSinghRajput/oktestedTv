...
public class ImageCardDesignView extends BaseCardView {
     ...
     */
    @Deprecated
    public ImageCardDesignView(Context context, int themeResId) {
     ...
     */
    public ImageCardDesignView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void buildImageCardView(AttributeSet attrs, int defStyleAttr, int defStyle) {
        ...
        mTitleView = findViewById(R.id.exclusiveName);
     ...
     */
    public ImageCardDesignView(Context context) {
        this(context, null);
    }
     ...
     */
    public ImageCardDesignView(Context context, AttributeSet attrs) {
